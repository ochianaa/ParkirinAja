...
const Home = () => {
    return (
        <section id='home' className="bg-gradient-to-b from-slate-900 to-blue-950 text-white">
            <div className="container mx-auto px-34 py-15 text-center">
                <TypeAnimation
                    sequence={[
                    ...
                    repeat={Infinity}
                />
                <p className="text-xl text-slate-300 mb-15">Discover secure, affordable garage spaces in your area. <br/> Book instantly and park with confidence.</p>

...
const SearchForm = () => {
    return (
        <div className='w-full flex justify-center'>
            <div className="bg-white text-gray-700 p-8 w-5/6 rounded-xl shadow-lg shadow-cyan-800 mt-20">
                <div className='flex flex-row gap-4 mb-6'>
                    ...
                    <div className='w-fit flex items-end'>
                        <button className='bg-slate-800 text-white w-full py-2 px-10 border rounded-lg hover:bg-transparent hover:text-gray-600 flex items-center justify-center gap-2'>
                            <FaSearch />
                            Search
                        </button>
                    </div>

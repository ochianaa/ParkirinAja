...
const ReviewModal = ({ isOpen, onClose, bookingId, onReviewSubmitted }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            await bookingService.addReview(bookingId, payload);
            setRating(0);
            setReviewText('');
            ...
            <div className="bg-white p-8 rounded-lg shadow-xl w-full max-w-lg" onClick={(e) => e.stopPropagation()}>
                ...
                <form className="space-y-6" onSubmit={handleSubmit}>
                    ...
                    <div className="flex justify-end gap-4 pt-4 border-t">
                         <button type="button" onClick={handleClose} className="px-6 py-2 bg-gray-200 text-gray-700 rounded-lg font-semibold hover:bg-gray-300">
                            Cancel
                        </button>
                        <button type="submit" className="bg-slate-800 text-white px-6 py-2 rounded-lg font-semibold hover:bg-slate-700" disabled={submitting}>
